 ...
 */
std::vector<std::string> SWIPL::functor2vector(std::string functor){
 ...
 */   
bool SWIPL::consult(std::string path){
 ...
 */
std::vector<std::string> SWIPL::list2vector(std::string list){
 ...
 * @return SWI term
 */
PlTerm SWIPL::string2term(std::string str, std::unordered_map<std::string, PlTerm> &swi_vars){
 ...
 */
std::string SWIPL::query(std::string request){
